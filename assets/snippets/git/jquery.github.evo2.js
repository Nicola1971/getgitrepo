		...
		"<div class='github-box'>" +
			"<div class='github-box-header'>" +
				...
				"<div class='github-stats'>" +
					"<a class='repo-stars' title='Stars' data-icon='7' target='_blank' href='" + this.url + "/stargazers'>" + this.stargazers + "</a>" +
					"<a class='repo-forks' title='Forks' data-icon='f' target='_blank' href='" + this.url + "/network'>" + this.forks + "</a>" +
					"<a class='repo-issues' title='Issues' data-icon='i' target='_blank' href='" + this.url + "/issues'>" + this.open_issues + "</a>" +
				"</div>" +
			"</div>" +
			"<div class='github-box-content'>" +
				"<p>" + this.description + " &mdash; <a target='_blank' href='" + this.url + "#readme'>Read More</a></p>" +
        		"<p>Latest commit to <strong>master</strong> on " + this.pushed_at + "</p>" +
			"</div>" +
			"<div class='github-box-download'>" +
        		"<a class='repo-butt-issues btn btn-warning' title='Report Issue' target='_blank' href='"+this.url+"/issues'><i class='fa fa-github' aria-hidden='true'></i> Report Issue</a>" +
				"<a class='repo-download btn btn-default' title='Download as zip' data-icon='w' href='"+this.url+"/zipball/master'><i class='fa fa-github' aria-hidden='true'></i> Download</a>" +
			"</div>" +
		"</div>");
};
...
Github.prototype.displayIcons = function () {
	...
	$buttonIssues.css( "display", options.buttonIssues ? "inline-block" : "none" );
};
